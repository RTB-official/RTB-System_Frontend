...
const STATUS_COLOR: Record<ReportStatus, { dot: string; bg: string; text: string; border: string }> = {
  submitted: { dot: 'bg-blue-500', bg: 'bg-blue-50', text: 'text-blue-700', border: 'border-blue-100' },
  pending: { dot: 'bg-emerald-500', bg: 'bg-emerald-50', text: 'text-emerald-700', border: 'border-emerald-100' },
  not_submitted: { dot: 'bg-gray-300', bg: 'bg-gray-50', text: 'text-gray-600', border: 'border-gray-100' },
};

const MOCK_REPORTS: ReportItem[] = [
  { id: 1, title: '11월13일 K-2010A3 cylinder overhaul후 시운전', place: 'S-OIL 온산', supervisor: '—', owner: '강민지', date: '2025.11.26', status: 'pending' },
  { id: 2, title: '11월13일 K-2010A3 cylinder overhaul후 시운전', place: 'S-OIL 온산', supervisor: '—', owner: '강민지', date: '2025.11.25', status: 'submitted' },
  { id: 3, title: '11월13일 K-2010A3 cylinder overhaul후 시운전', place: 'S-OIL 온산', supervisor: '—', owner: '강민지', date: '2025.11.24', status: 'submitted' },
  { id: 4, title: '11월13일 K-2010A3 cylinder overhaul후 시운전', place: 'S-OIL 온산', supervisor: '—', owner: '강민지', date: '2025.11.24', status: 'pending' },
  { id: 5, title: '11월13일 K-2010A3 cylinder overhaul후 시운전', place: 'S-OIL 온산', supervisor: '—', owner: '강민지', date: '2025.11.24', status: 'submitted' },
  { id: 6, title: '11월13일 K-2010A3 cylinder overhaul후 시운전', place: 'S-OIL 온산', supervisor: '—', owner: '강민지', date: '2025.11.24', status: 'submitted' },
  { id: 7, title: '11월13일 K-2010A3 cylinder overhaul후 시운전', place: 'S-OIL 온산', supervisor: '—', owner: '강민지', date: '2025.11.24', status: 'submitted' },
  { id: 8, title: '11월13일 K-2010A3 cylinder overhaul후 시운전', place: 'S-OIL 온산', supervisor: '—', owner: '강민지', date: '2025.11.24', status: 'submitted' },
  { id: 9, title: '11월13일 K-2010A3 cylinder overhaul후 시운전', place: 'S-OIL 온산', supervisor: '—', owner: '강민지', date: '2025.11.24', status: 'submitted' },
  { id: 10, title: '11월13일 K-2010A3 cylinder overhaul후 시운전', place: 'S-OIL 온산', supervisor: '—', owner: '강민지', date: '2025.11.24', status: 'submitted' },
  { id: 11, title: '11월13일 K-2010A3 cylinder overhaul후 시운전', place: 'S-OIL 온산', supervisor: '—', owner: '강민지', date: '2025.11.24', status: 'submitted' },
  {
    id: 12,
    title:
      '11월26일~11월27일 SH8218 Replacement of guide tool for LGI Connector Pipe, Installation of blow off Valves Leakage test',
    place: 'S-OIL 온산',
    supervisor: '—',
    owner: '강민지',
    date: '2025.11.24',
...
export default function ReportListPage() {
  ...
  const filtered = useMemo(() => {
    return MOCK_REPORTS.filter((r) => {
      const matchSearch = r.title.includes(search) || r.owner.includes(search) || r.place.includes(search);
      return matchSearch;
    });
  }, [search]);
  ...
  return (
    <div className="flex h-screen bg-[#f4f5f7] overflow-hidden">
      ...
      >
        <Sidebar onClose={() => setSidebarOpen(false)} activeMenu="출장 보고서" />
      </div>
        ...
        <div className="flex-1 overflow-y-auto px-4 lg:px-12 py-6">
          <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-4 lg:p-6 flex flex-col gap-4">
            ...
            <div className="overflow-auto border border-gray-200 rounded-xl">
              <table className="min-w-full text-[12.5px] text-gray-800">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr className="text-left">
                    <th className="px-4 py-3 font-semibold text-gray-600 w-24">작성자</th>
                    <th className="px-4 py-3 font-semibold text-gray-600 w-[45%]">제목</th>
                    <th className="px-4 py-3 font-semibold text-gray-600 w-28">출장지</th>
                    <th className="px-4 py-3 font-semibold text-gray-600 w-24">참감독</th>
                    <th className="px-4 py-3 font-semibold text-gray-600 w-28">작성일</th>
                    <th className="px-3 py-3 font-semibold text-gray-600 w-28">상태</th>
                    <th className="px-2 py-3 w-10 text-right"></th>
                  </tr>
                </thead>
                <tbody>
                  {filtered.map((item) => {
                    ...
                    return (
                      <tr key={item.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-4 py-3 text-gray-500">{item.supervisor}</td>
            ...
            <div className="flex items-center justify-center gap-2 text-[12.5px] text-gray-600">
              ...
              <div className="flex items-center gap-1">
                <button className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-100 font-medium text-gray-800">1</button>

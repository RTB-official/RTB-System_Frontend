...
// 샘플 테이블 데이터
const tableData = [
  { id: 1, name: '홍길동', work: '93시간', travel: '21시간 30분', wait: '0시간', days: '11일' },
  { id: 2, name: '홍길동', work: '93시간', travel: '21시간 30분', wait: '0시간', days: '11일' },
  { id: 3, name: '홍길동', work: '93시간', travel: '21시간 30분', wait: '0시간', days: '11일' },
  { id: 4, name: '홍길동', work: '93시간', travel: '21시간 30분', wait: '0시간', days: '11일' },
  { id: 5, name: '홍길동', work: '93시간', travel: '21시간 30분', wait: '0시간', days: '11일' },
  { id: 6, name: '홍길동', work: '93시간', travel: '21시간 30분', wait: '0시간', days: '11일' },
  { id: 7, name: '홍길동', work: '93시간', travel: '21시간 30분', wait: '0시간', days: '11일' },
  { id: 8, name: '홍길동', work: '93시간', travel: '21시간 30분', wait: '0시간', days: '11일' },
  { id: 9, name: '홍길동', work: '93시간', travel: '21시간 30분', wait: '0시간', days: '11일' },
  { id: 10, name: '홍길동', work: '93시간', travel: '21시간 30분', wait: '0시간', days: '11일' },
];
      ...
      <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-lg">
        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-sm text-gray-600">작업 {payload[0]?.value}시간</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-3.5 h-3.5 rounded bg-[#fd9a00]" />
            <span className="text-sm text-gray-600">이동 {payload[1]?.value}시간</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-3.5 h-3.5 rounded bg-[#d1d5dc]" />
            <span className="text-sm text-gray-600">대기 {payload[2]?.value}시간</span>
          </div>
        </div>
      </div>
    );
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
                ...
                <div className="flex items-center gap-5">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[13px] text-gray-500">작업</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <div className="w-4 h-4 rounded bg-[#fd9a00]" />
                    <span className="text-[13px] text-gray-500">이동</span>
                  </div>
                  <div className="flex items-center gap-1.5">
              ...
              <div className="h-[300px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={chartData} margin={{ top: 20, right: 20, left: 0, bottom: 5 }}>
                    ...
                    <Bar dataKey="대기" stackId="a" fill="#d1d5dc" radius={[4, 4, 0, 0]} />
                    <Bar dataKey="이동" stackId="a" fill="#fd9a00" />
                    <Bar dataKey="작업" stackId="a" fill="#51a2ff" radius={[0, 0, 4, 4]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </div>
                ...
                <table className="w-full border border-gray-200 rounded-lg overflow-hidden">
                  <thead>
                    <tr className="bg-gray-100">
                      <th className="px-5 py-3 text-left font-semibold text-gray-900">이름</th>
                      <th className="px-5 py-3 text-left font-semibold text-gray-900">작업</th>
                      <th className="px-5 py-3 text-left font-semibold text-gray-900">이동</th>
                      <th className="px-5 py-3 text-left font-semibold text-gray-900">대기</th>
                      <th className="px-5 py-3 text-left font-semibold text-gray-900">일수</th>
                    </tr>
                  </thead>
                  <tbody>
                    {tableData.map((row) => (
                      <tr 
                        ...
                        className={`border-t border-gray-100 transition-colors ${
                          hoveredRow === row.id ? 'bg-blue-50' : 'hover:bg-gray-50'
                        }`}
                      ...
                      >
                        ...
                        <td className="px-5 py-3 text-gray-900">{row.work}</td>
                        <td className="px-5 py-3 text-gray-900">{row.travel}</td>
                        <td className="px-5 py-3 text-gray-900">{row.wait}</td>
                        <td className="px-5 py-3 text-gray-900">{row.days}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
